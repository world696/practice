 ...
 * --- apiKey-OpenAI 密钥
 * --- model-embedding 模型
 * --- dimensions-向量纬度;高维浮点数数组
 * --- batchSize-批量大小
 * --- batchSize-请求大小
 *
 * 核心方法:
 * 1、embedQuery(text) 用于“查询文本”向量化。
 * eg:
 *   const vector = await embeddings.embedQuery("什么是RAG?");
 *   number[]
 * 2、embedDocuments(texts: string[]) 用于批量文档向量化。
 * 3、embed(texts) 某些版本中存在的底层统一方法。
 */
